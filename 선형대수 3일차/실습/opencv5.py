...
# 45도를 라디안으로 변환하여 코사인값과 사인값을 구합니다.
angle = 45
...
# 회전 변환 행렬을 구성합니다.
# OpenCV의 원점이 왼쪽 아래가 아니라, 왼쪽 위라서 [[c, -s, 0], [s, c, 0]]가 아니라 [[c, s, 0], [-s, c, 0] 입니다.
...
for y in range(height - 1):
    for x in range(width - 1):
        # backward mapping
        # 결과 이미지의 픽셀 new_p로 이동하는 입력 이미지의 픽셀 old_p의 위치를 계산합니다.
        ...
        # 입력 이미지의 픽셀을 가져올 수 있는 경우에만 결과 이미지의 현재 위치 픽세로 사용합니다.
